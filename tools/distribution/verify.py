...
from tools.distribution.distrotest import (
    DistroTest, DockerTestImage, DebDockerTestImage, RPMDockerTestImage)


class DebDistroTest(DistroTest):

    @property
    def builder_class(self) -> Type[DockerTestImage]:
        return DebDockerTestImage
